        ...
        <div className="w-full lg:w-2/5 flex flex-col justify-center px-4 md:px-5 lg:px-0">
          <div className="max-w-[400px] mx-auto w-full text-center">
            <div className="mb-8">
              ...
              <h1 className="text-[32px] md:text-[40px] font-bold text-dark-100 mb-4">
                Page Not Found
              </h1>
              <p className="text-dark-60 text-[16px] mb-8">
            ...
            <div className="space-y-4">
              ...
              <Link href="/search-property">
                <ButtonText variant="secondary" className="w-full py-4 text-[16px]">
                  Browse Properties
                </ButtonText>
              </Link>
            </div>
            ...
            <div className="mt-8 space-y-2">
              <p className="text-dark-60 text-[14px]">Need help?</p>
              <div className="flex justify-center gap-4">
                <Link href="/sign-in" className="text-primary-500 text-[14px] hover:underline">
                  Sign In
                </Link>
                <Link href="/sign-up" className="text-primary-500 text-[14px] hover:underline">
                  Sign Up
                </Link>
              </div>
            </div>
